...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : USB_FS_PWR_EN_Pin GPIO_DEBUG_Pin */
  ...
  /*Configure GPIO pins : ENC_DIR_Pin ENC_PRESET_Pin */
