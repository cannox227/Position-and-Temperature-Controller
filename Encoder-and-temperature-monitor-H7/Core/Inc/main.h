...
#define NTC_GPIO_Port GPIOF
#define PTC_Pin GPIO_PIN_5
#define PTC_GPIO_Port GPIOF
...
#define SSI_ENC_DATA_Pin GPIO_PIN_2
#define SSI_ENC_DATA_GPIO_Port GPIOG
#define SSI_ENC_CLK_Pin GPIO_PIN_3
#define SSI_ENC_CLK_GPIO_Port GPIOG
...
#define ENC_DIR_Pin GPIO_PIN_11
#define ENC_DIR_GPIO_Port GPIOC
#define ENC_PRESET_Pin GPIO_PIN_12
#define ENC_PRESET_GPIO_Port GPIOC
#define GPIO_DEBUG_Pin GPIO_PIN_2
#define GPIO_DEBUG_GPIO_Port GPIOD
